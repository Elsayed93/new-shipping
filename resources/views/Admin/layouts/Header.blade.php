...
<header class="header white-bg fixed-top d-flex align-content-center flex-wrap">
    ...
    <div class="logo">
        ...
        <a href="/" class="mobile-logo"><img
                src="{{ $settings->image ? asset('images/' . $settings->image) : asset('admin/ar/assets/img/mobile-logo.png') }}"
                alt=""></a>
    </div>
    <!-- End Logo -->
                        ...
                        <div class="main-header-user">
                            ...
                            <div class="dropdown-menu">
                                <form action="{{ route('logout') }}" method="POST" id="logoutForm">
                                    @csrf
                                    <button type="submit" style="background-color: #182335;color: white;margin-left: 15px;">Log Out</button>
                            ...
                            <li>
                                ...
                                <div class="main-header-notification">
                                    <a href="#" class="header-icon notification-icon" data-toggle="dropdown">
                                        <span class="count"
                                            data-bg-img="{{ asset('admin/ar/assets/img/count-bg.png') }}">50</span>
                                        <img src="{{ asset('admin/ar/assets/img/svg/notification-icon.svg') }}"
                                            alt="" class="svg">
